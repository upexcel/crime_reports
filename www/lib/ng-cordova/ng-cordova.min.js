...
!function() {
    angular.module("ngCordova", ["ngCordova.plugins"]), angular.module("ngCordova.plugins.actionSheet", []).factory("$cordovaActionSheet", ["$q", "$window", function(e, n) {
            ...
            this.setPreferences = function(e) {
                ...
                n = angular.extend(n, e), AppRate.preferences.customLocale = n
                    ...
                    return{promptForRating: function(n) {
                            var r = e.defer(), t = AppRate.promptForRating(n);
            ...
            return{createCalendar: function(r) {
                    var t = e.defer(), o = n.plugins.calendar.getCreateCalendarOptions();
                    ...
                    var t = e.defer(), o = {title: null, location: null, notes: null, startDate: null, endDate: null};
                    ...
                    var t = e.defer(), o = [], i = window.plugins.calendar.getCalendarOptions(), a = {title: null, location: null, notes: null, startDate: null, endDate: null};
                    o = Object.keys(a);
                    for (var c in r)
                        -1 === o.indexOf(c) ? i[c] = r[c] : a[c] = r[c];
                    ...
                    var t = e.defer(), o = {title: null, location: null, notes: null, startDate: null, endDate: null, calendarName: null};
                    ...
                    var t = e.defer(), o = {title: null, location: null, notes: null, startDate: null, endDate: null, newTitle: null, newLocation: null, newNotes: null, newStartDate: null, newEndDate: null};
                    ...
                    var t = e.defer(), o = {newTitle: null, location: null, notes: null, startDate: null, endDate: null};
            ...
            return{save: function(n) {
                    var r = e.defer(), t = navigator.contacts.create(n);
                    ...
                    var r = e.defer(), t = n.fields || ["id", "displayName"];
            ...
            return{getCurrentAcceleration: function() {
                    ...
                    var r = e.defer(), t = navigator.accelerometer.watchAcceleration(function(e) {
                        r.notify(e)
                    }, function(e) {
                        r.reject(e)
                    }, n);
            ...
            return{getCurrentHeading: function() {
                    ...
                    var t = e.defer(), o = angular.extend(n, r), i = navigator.compass.watchHeading(function(e) {
                        t.notify(e)
                    }, function(e) {
                        t.reject(e)
                    }, o);
            ...
            return{alert: function(r, t, o) {
                    ...
                    if (n.navigator.notification)
                        navigator.notification.prompt(r, function(e) {
                            a.resolve(e)
                        }, t, o, i);
                    else {
                        var c = n.prompt(r, i);
            ...
            return{download: function(r, t, o, i) {
                    var a = e.defer(), c = new FileTransfer, s = o && o.encodeURI === !1 ? r : encodeURI(r);
            ...
            return{getCurrentPosition: function(n) {
                    ...
                    var r = e.defer(), t = navigator.geolocation.watchPosition(function(e) {
                        r.notify(e)
                    }, function(e) {
                        r.reject(e)
                    }, n);
            ...
            return{isAvailable: function() {
                    ...
                    var i = e.defer();
                    return n.plugins.healthkit.saveWeight({unit: t || "lb", amount: r, date: o || new Date}, function(e) {
                        i.resolve(e)
                    }, function(e) {
                        i.resolve(e)
                    }), i.promise
                    ...
                    var i = e.defer();
                    return n.plugins.healthkit.saveHeight({unit: t || "in", amount: r, date: o || new Date}, function(e) {
                        i.resolve(e)
                    }, function(e) {
                        i.resolve(e)
                    }), i.promise
            ...
            this.setDefaultOptions = function(e) {
                n = angular.extend(n, e)
                    ...
                    return{open: function(a, c, s) {
                            var u = t.defer();
                            if (s && !angular.isObject(s))
                                return u.reject("options must be an object"), u.promise;
            ...
            return{newMedia: function(n) {
                    ...
                    return r = new Media(n, function(e) {
                        ...
                        r.getCurrentPosition(function(e) {
                        }, function(e) {
                        })
            ...
            return{preloadSimple: function(r, t) {
                    var o = e.defer();
        ...
        }]), angular.module("ngCordova.plugins.oauth", ["ngCordova.plugins.oauthUtility"]).factory("$cordovaOauth", ["$q", "$http", "$cordovaOauthUtility", function(e, n, r) {
            return{adfs: function(r, t, o) {
                    var i = e.defer();
                    if (window.cordova) {
                        ...
                        if (a.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || a.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            c.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf("http://localhost/callback")) {
                                    ...
                                    n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({method: "post", url: t + "/adfs/oauth2/token", data: "client_id=" + r + "&code=" + o + "&redirect_uri=http://localhost/callback&grant_type=authorization_code"}).success(function(e) {
                                        i.resolve(e)
                                    }).error(function(e, n) {
                        ...
                        if (o.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || o.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            a.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf(i)) {
                                    ...
                                    for (var n = e.url.split("#")[1], r = n.split("&"), o = [], c = 0; c < r.length; c++)
                                        o[r[c].split("=")[0]] = r[c].split("=")[1];
                                    void 0 !== o.access_token && null !== o.access_token ? t.resolve({access_token: o.access_token, token_type: o.token_type, uid: o.uid}) : t.reject("Problem authenticating")
                                }
                        ...
                        if (i.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || i.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            a.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf("http://localhost/callback")) {
                                    ...
                                    n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({method: "post", url: "https://cloud.digitalocean.com/v1/oauth/token", data: "client_id=" + r + "&client_secret=" + t + "&redirect_uri=http://localhost/callback&grant_type=authorization_code&code=" + i}).success(function(e) {
                                        o.resolve(e)
                                    }).error(function(e, n) {
                        ...
                        if (i.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || i.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            c.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf(a)) {
                                    ...
                                    for (var n = e.url.split("#")[1], r = n.split("&"), t = [], i = 0; i < r.length; i++)
                                        t[r[i].split("=")[0]] = r[i].split("=")[1];
                                    void 0 !== t.access_token && null !== t.access_token ? o.resolve({access_token: t.access_token, token_type: t.token_type, expires_in: t.expires_in}) : o.reject("Problem authenticating")
                                }
                            }), c.addEventListener("exit", function(e) {
                                o.reject("The sign in flow was canceled")
                            })
                        ...
                        if (i.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || i.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            c.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf(a)) {
                                    ...
                                    for (var n = e.url.split("#")[1], r = n.split("&"), t = [], i = 0; i < r.length; i++)
                                        t[r[i].split("=")[0]] = r[i].split("=")[1];
                                    void 0 !== t.access_token && null !== t.access_token ? o.resolve({access_token: t.access_token, expires_in: t.expires_in}) : 0 !== e.url.indexOf("error_code=100") ? o.reject("Facebook returned error_code=100: Invalid permissions") : o.reject("Problem authenticating")
                                }
                            }), c.addEventListener("exit", function(e) {
                                o.reject("The sign in flow was canceled")
                            })
                        ...
                        if (c.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || c.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            l.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf(s)) {
                                    ...
                                    var n = e.url.split(a[u])[1], t = r.parseResponseParameters(n);
                                    void 0 !== t.access_token && null !== t.access_token ? i.resolve({access_token: t.access_token}) : void 0 !== t.code && null !== t.code ? i.resolve({code: t.code}) : i.reject("Problem authenticating")
                                }
                    ...
                    if (window.cordova) {
                        ...
                        if (a.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || a.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            c.addEventListener("loadstart", function(e) {
                                0 === e.url.indexOf("http://localhost/callback") && (requestToken = e.url.split("code=")[1], n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n.defaults.headers.post.Authorization = "Basic " + btoa(r + ":" + t), n({method: "post", url: "https://ssl.reddit.com/api/v1/access_token", data: "redirect_uri=http://localhost/callback&grant_type=authorization_code&code=" + requestToken}).success(function(e) {
                                    i.resolve(e)
                                }).error(function(e, n) {
                                    i.reject("Problem authenticating")
                                })["finally"](function() {
                    ...
                    if (window.cordova) {
                        var c = cordova.require("cordova/plugin_list").metadata;
                        if (c.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || c.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            var s = "http://twitter.com";
                            if (void 0 !== i && i.hasOwnProperty("redirect_uri") && (s = i.redirect_uri), "undefined" != typeof jsSHA) {
                                var u = {oauth_consumer_key: t, oauth_nonce: r.createNonce(10), oauth_signature_method: "HMAC-SHA1", oauth_timestamp: Math.round((new Date).getTime() / 1e3), oauth_version: "1.0"}, l = r.createSignature("POST", "https://api.twitter.com/oauth/request_token", u, {oauth_callback: s}, o);
                                n({method: "post", url: "https://api.twitter.com/oauth/request_token", headers: {Authorization: l.authorization_header, "Content-Type": "application/x-www-form-urlencoded"}, data: "oauth_callback=" + encodeURIComponent(s)}).success(function(e) {
                                    for (var t = e.split("&"), i = {}, c = 0; c < t.length; c++)
                                        i[t[c].split("=")[0]] = t[c].split("=")[1];
                                    ...
                                    l.addEventListener("loadstart", function(e) {
                                        if (0 === e.url.indexOf(s)) {
                                            for (var t = e.url.split("?")[1], i = t.split("&"), c = {}, d = 0; d < i.length; d++)
                                                c[i[d].split("=")[0]] = i[d].split("=")[1];
                                            ...
                                            var f = r.createSignature("POST", "https://api.twitter.com/oauth/access_token", u, {oauth_verifier: c.oauth_verifier}, o);
                    ...
                    var t = "http://localhost/callback", o = function(e, n, r) {
                    ...
                    if (window.cordova) {
                        ...
                        if (a.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || a.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            c.addEventListener("loadstart", function(e) {
                                0 === e.url.indexOf("http://localhost/callback") && (requestToken = e.url.split("code=")[1], n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({method: "post", url: "https://www.strava.com/oauth/token", data: "client_id=" + r + "&client_secret=" + t + "&code=" + requestToken}).success(function(e) {
                                    i.resolve(e)
                                }).error(function(e, n) {
                                    i.reject("Problem authenticating")
                                })["finally"](function() {
                    ...
                    if (window.cordova) {
                        ...
                        if (a.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || a.hasOwnProperty("org.apache.cordova.inappbrowser") === !0)
                            if ("undefined" != typeof jsSHA) {
                                ...
                                var s = "https://oauth.withings.com/account/request_token", u = r.createSignature("GET", s, {}, c, o);
                                ...
                                n({method: "get", url: s + "?" + l}).success(function(e) {
                                    ...
                                    var s = a.oauth_token_secret, u = "https://oauth.withings.com/account/authorize", l = r.createSignature("GET", u, {}, c, o);
                                    c.oauth_signature = l.signature;
                                    var d = r.generateUrlParameters(c), f = window.open(u + "?" + d, "_blank", "location=no,clearsessioncache=yes,clearcache=yes");
                                    f.addEventListener("loadstart", function(e) {
                                        if (0 === e.url.indexOf("http://localhost/callback")) {
                                            ...
                                            var l = "https://oauth.withings.com/account/access_token", d = r.createSignature("GET", l, {}, u, o, s);
                            ...
                            a.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf(i)) {
                                    ...
                                    if (void 0 !== o.access_token && null !== o.access_token) {
                                        var s = {access_token: o.access_token, expires_in: o.expires_in};
                                        t.resolve(s)
                                    } else
                    ...
                    if (window.cordova) {
                        ...
                        if (c.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || c.hasOwnProperty("org.apache.cordova.inappbrowser") === !0)
                            if ("undefined" != typeof jsSHA) {
                                var s = {oauth_callback: "http://localhost/callback", oauth_consumer_key: o, oauth_nonce: r.createNonce(5), oauth_signature_method: "HMAC-SHA1", oauth_timestamp: Math.round((new Date).getTime() / 1e3), oauth_version: "1.0"}, u = r.createSignature("POST", t + "/oauth/initiate", s, {oauth_callback: "http://localhost/callback"}, i);
                                n.defaults.headers.post.Authorization = u.authorization_header, n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({method: "post", url: t + "/oauth/initiate", data: "oauth_callback=http://localhost/callback"}).success(function(e) {
                                    for (var o = e.split("&"), c = {}, u = 0; u < o.length; u++)
                                        c[o[u].split("=")[0]] = o[u].split("=")[1];
                                    c.hasOwnProperty("oauth_token") === !1 && a.reject("Oauth request token was not received");
                                    var l = c.oauth_token_secret, d = window.open(t + "/oauth/authorize?oauth_token=" + c.oauth_token, "_blank", "location=no,clearsessioncache=yes,clearcache=yes");
                                    d.addEventListener("loadstart", function(e) {
                                        if (0 === e.url.indexOf("http://localhost/callback")) {
                                            for (var o = e.url.split("?")[1], c = o.split("&"), u = {}, f = 0; f < c.length; f++)
                                                u[c[f].split("=")[0]] = c[f].split("=")[1];
                                            ...
                                            n.defaults.headers.post.Authorization = p.authorization_header, n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({method: "post", url: t + "/oauth/token"}).success(function(e) {
                                                for (var n = e.split("&"), r = {}, t = 0; t < n.length; t++)
                                                    r[n[t].split("=")[0]] = n[t].split("=")[1];
                                                r.hasOwnProperty("oauth_token_secret") === !1 && a.reject("Oauth access token was not received"), a.resolve(r)
                                            }).error(function(e) {
                        ...
                        if (o.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || o.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            i.addEventListener("loadstart", function(e) {
                                ...
                                if ("https://oauth.vk.com/blank.html" == n[0] || "http://oauth.vk.com/blank.html" == n[0]) {
                                    i.removeEventListener("exit", function(e) {
                                    }), i.close();
                                    for (var r = e.url.split("#")[1], o = r.split("&"), a = [], c = 0; c < o.length; c++)
                                        a[o[c].split("=")[0]] = o[c].split("=")[1];
                                    if (void 0 !== a.access_token && null !== a.access_token) {
                                        var s = {access_token: a.access_token, expires_in: a.expires_in};
                    ...
                    if (window.cordova) {
                        ...
                        if (o.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || o.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            i.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf("http://localhost/callback")) {
                                    for (var n = e.url.split("#")[1], r = n.split("&"), o = [], a = 0; a < r.length; a++)
                                        o[r[a].split("=")[0]] = r[a].split("=")[1];
                                    void 0 !== o.access_token && null !== o.access_token ? t.resolve({access_token: o.access_token, session_secret_key: o.session_secret_key}) : t.reject("Problem authenticating"), setTimeout(function() {
                                        i.close()
                                    }, 10)
                                }
                            }), i.addEventListener("exit", function(e) {
                        ...
                        if (o.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || o.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            a.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf(i)) {
                                    ...
                                    for (var n = e.url.split("#")[1], r = n.split("&"), o = [], c = 0; c < r.length; c++)
                                        o[r[c].split("=")[0]] = r[c].split("=")[1];
                                    void 0 !== o.access_token && null !== o.access_token ? t.resolve({access_token: o.access_token, expires_in: o.expires_in, account_username: o.account_username}) : t.reject("Problem authenticating")
                                }
                            }), a.addEventListener("exit", function(e) {
                                t.reject("The sign in flow was canceled")
                            })
                        ...
                        if (i.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || i.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            c.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf(a)) {
                                    ...
                                    for (var n = e.url.split("#")[1], r = n.split("&"), t = [], i = 0; i < r.length; i++)
                                        t[r[i].split("=")[0]] = r[i].split("=")[1];
                                    void 0 !== t.access_token && null !== t.access_token ? o.resolve({access_token: t.access_token, expires_in: t.expires_in, account_username: t.account_username}) : o.reject("Problem authenticating")
                                }
                            }), c.addEventListener("exit", function(e) {
                                o.reject("The sign in flow was canceled")
                            })
                        ...
                        if (i.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || i.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            c.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf(a)) {
                                    ...
                                    for (var n = e.url.split("#")[1], r = n.split("&"), t = [], i = 0; i < r.length; i++)
                                        t[r[i].split("=")[0]] = r[i].split("=")[1];
                                    void 0 !== t.access_token && null !== t.access_token ? o.resolve({access_token: t.access_token, token_type: t.token_type, expires_in: t.expires_in, scope: t.scope}) : o.reject("Problem authenticating")
                                }
                            }), c.addEventListener("exit", function(e) {
                                o.reject("The sign in flow was canceled")
                            })
                        ...
                        if (i.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || i.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            c.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf(a)) {
                                    ...
                                    for (var n = e.url.split("#")[1], r = n.split("&"), t = [], i = 0; i < r.length; i++)
                                        t[r[i].split("=")[0]] = r[i].split("=")[1];
                                    void 0 !== t.access_token && null !== t.access_token ? o.resolve({access_token: t.access_token, expires_in: t.expires_in}) : o.reject("Problem authenticating")
                                }
                            }), c.addEventListener("exit", function(e) {
                                o.reject("The sign in flow was canceled")
                            })
                        ...
                        if (o.hasOwnProperty("cordova-plugin-inappbrowser") === !0 || o.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                            ...
                            a.addEventListener("loadstart", function(e) {
                                if (0 === e.url.indexOf(i)) {
                                    ...
                                    for (var n = e.url.split("#")[1], r = n.split("&"), o = [], c = 0; c < r.length; c++)
                                        o[r[c].split("=")[0]] = r[c].split("=")[1];
                                    void 0 !== o.access_token && null !== o.access_token ? t.resolve({access_token: o.access_token}) : t.reject("Problem authenticating")
                                }
                            }), a.addEventListener("exit", function(e) {
                                t.reject("The sign in flow was canceled")
                            })
            ...
            return{createSignature: function(e, n, r, t, o, i) {
                    if ("undefined" != typeof jsSHA) {
                        for (var a = angular.copy(r), c = Object.keys(t), s = 0; s < c.length; s++)
                            a[c[s]] = encodeURIComponent(t[c[s]]);
                        var u = e + "&" + encodeURIComponent(n) + "&", l = Object.keys(a).sort();
                        for (s = 0; s < l.length; s++)
                            u += s == l.length - 1 ? encodeURIComponent(l[s] + "=" + a[l[s]]) : encodeURIComponent(l[s] + "=" + a[l[s]] + "&");
                        ...
                        var p = Object.keys(r), v = "OAuth ";
                        for (s = 0; s < p.length; s++)
                            v += s == p.length - 1 ? p[s] + '="' + r[p[s]] + '"' : p[s] + '="' + r[p[s]] + '",';
                        return{signature_base_string: u, authorization_header: v, signature: r.oauth_signature}
                    }
                    return"Missing jsSHA JavaScript library"
                }, createNonce: function(e) {
                    for (var n = "", r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", t = 0; e > t; t++)
                    ...
                    var n = new jsSHA(Math.round((new Date).getTime() / 1e3), "TEXT"), r = {oauth_consumer_key: e, oauth_nonce: n.getHash("SHA-1", "HEX"), oauth_signature_method: "HMAC-SHA1", oauth_timestamp: Math.round((new Date).getTime() / 1e3), oauth_version: "1.0"};
                    return r
                }}
        }]), angular.module("ngCordova.plugins.pinDialog", []).factory("$cordovaPinDialog", ["$q", "$window", function(e, n) {
            return{prompt: function(r, t, o) {
                    var i = e.defer();
            ...
            return{openDB: function(e, r) {
                    return"undefined" == typeof r && (r = 0), n.sqlitePlugin.openDatabase({name: e, bgType: r})
            ...
            this.setLimit = function(n) {
                ...
                e.overlayText = n
                    ...
                    return{captureVideo: function(t) {
                            var o = n.defer();
